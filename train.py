...
tf.app.flags.DEFINE_integer(
    'num_clones', 1, 'Number of model clones to deploy. Note For '
...
tf.app.flags.DEFINE_integer('num_samples', 3303, 'Number of samples.')
tf.app.flags.DEFINE_integer('num_classes', 5, 'Number of classes.')
tf.app.flags.DEFINE_string('labels_to_names_path', None,
                           'Label names file path.')
